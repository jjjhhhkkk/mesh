        ...
        this.context.memo('button.color', function () {
            return _this.ui.buttonGroup({
                ...
                children: [
                    ...
                    _this.button({
                        className: 'dropdown-toggle',
                        // contents: _this.ui.icon(_this.options.icons.font + ' note-recent-color') + ' <i class="fa fa-caret-down"></i>',
                        contents: '<i class="note-icon-font" style="background-color: #FFFF00;"></i> <i class="fa fa-caret-down"></i>',
